...
Java_com_vuforia_engine_native_1sample_VuforiaActivity_initAR(
    JNIEnv *env,
    jobject /* this */,
    jobject activity,
...
Java_com_vuforia_engine_native_1sample_VuforiaActivity_startAR(
        JNIEnv * /* env */,
        jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_stopAR(
    JNIEnv * /* env */,
    jobject /* this */)
{
    controller.stopAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_deinitAR(
        JNIEnv *env,
        jobject /* this */)
{
    controller.deinitAR();
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_cameraPerformAutoFocus(
    JNIEnv * /* env */,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_cameraRestoreAutoFocus(
    JNIEnv * /* env */,
    jobject /* this */)
{
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_initRendering(
        JNIEnv * /* env */,
        jobject /* this */)
{
    // Define clear color
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_setTextures(
    JNIEnv *env,
    jobject /* this */,
...
JNIEXPORT void JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_deinitRendering(
    JNIEnv * /* env */,
    jobject /* this */)
{
...
JNIEXPORT jboolean JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_configureRendering(
        JNIEnv * /* env */,
        jobject /* this */,
...
JNIEXPORT jboolean JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_renderFrame(
        JNIEnv * /* env */,
        jobject /* this */)
{
    ...
    if (controller.prepareToRender(viewport, &renderVideoBackgroundData))
    {
        ...
        gWrapperData.renderer.renderVideoBackground(
            renderState.vbProjectionMatrix,
            renderState.vbMesh->pos, renderState.vbMesh->tex,
            renderState.vbMesh->numFaces, renderState.vbMesh->faceIndices,
            vbTextureUnit);
        ...
        char* targetName = controller.getImageTargetResult(trackableProjection, trackableModelView, trackableModelViewScaled);
        if (strcmp(targetName, "false") != 0 )
        {
            gWrapperData.renderer.renderImageTarget(trackableProjection, trackableModelView, trackableModelViewScaled,targetName);
        }
        ...
        else if (controller.getModelTargetGuideView(trackableProjection, trackableModelView, modelTargetGuideViewImage, guideViewImageHasChanged))
        {
            gWrapperData.renderer.renderModelTargetGuideView(trackableProjection, trackableModelView, modelTargetGuideViewImage, guideViewImageHasChanged);
        }
...
JNIEXPORT jint JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_00024Companion_getImageTargetId(
    JNIEnv * /* env */,
    jobject /* this */)
{
...
JNIEXPORT jint JNICALL
Java_com_vuforia_engine_native_1sample_VuforiaActivity_00024Companion_getModelTargetId(
    JNIEnv * /* env */,
    jobject /* this */)
{
